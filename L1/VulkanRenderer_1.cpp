...
//	}
//
//	// Check Instance Extensions supported...  生成extension属性个数与数据，比对instanceExtension的name
...
//	std::cout << "Physica deviceCount: " << deviceCount;
...
//
//	// Create a list of VkExtensionProperties using count // 关心的是里面的name
...
//}
//// 每个物理设备都有types of queue（多种类型的queue），使每个队列都对应一个索引(这里看是人为设定)
...
//		if (queueFamily.queueCount > 0 && queueFamily.queueFlags & VK_QUEUE_GRAPHICS_BIT)  // 图形 计算  转换等BIT
//		{
